...
$obj | Add-Member -Type NoteProperty -Name "HRM_TelephoneWork|String" -Value "Active"
$obj | Add-Member -Type NoteProperty -Name "HRM_TelephonePrivate|String" -Value "Active"
